...
class CreateDiaryModal extends StatefulWidget {
  const CreateDiaryModal({super.key});

  @override
  State<CreateDiaryModal> createState() => _CreateDiaryModalState();
}

class _CreateDiaryModalState extends State<CreateDiaryModal> {
              ...
              child: Column(
                ...
                children: [
                  SearchAnchor.bar(
                    ...
                    barLeading: SvgPicture.asset(AssetImages.iconLocation, width: 16, height: 20,),
                    barShape: WidgetStateProperty.all(
                      RoundedRectangleBorder(borderRadius: BorderRadius.circular(12),
                      side: BorderSide(color: Color(0xffE5E7EA), width: 1.5),
                    )),
                    barBackgroundColor: WidgetStateProperty.all(Color(0xffF9FAFB)),
